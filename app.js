...
function updateDriveUi(){
  // IMPORTANT: updateDriveUi must never call restoreCachedDriveToken().
  // restoreCachedDriveToken() itself calls updateDriveUi(), so calling it here creates
  // an infinite loop and causes "Maximum call stack size exceeded".
